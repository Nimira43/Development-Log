window.addEventListener('load', function() {
    ...
    class Larva {
        ...
        update() {
            ...
            // include ...this.game.eggs to above line so lavae collide with eggs
            collisionObjects.forEach(object => {
                let [collision, distance, sumOfRadii, dx, dy] = this.game.checkCollision(this, object);
                if (collision) {
                    const unit_x = dx / distance;
    ...
    class Game {
        ...
        render(context, deltaTime) {
            ...
            if (this.debug) {
                context.fillText('Lost: ' + this.
                lostHatchlings, 25, 100);
            }
            context.restore();
            if (this.score >= this.winningScore) {
                ...
                if (this.lostHatchlings <= 10) {
                    message1 = "You are The Protector"
                    message2 = "You've saved the Larvakind"
                } else {
                    message1 = "You are a Failure"
                ...
                context.fillText("Final score: " + this.score, this.width * 0.5, this.height * 0.5 + 80);
                context.fillText("Press 'R' to restart game.", this.width * 0.5, this.height * 0.5 + 130);
                context.restore();
            }
        }
