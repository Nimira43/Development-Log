window.addEventListener('load', function() {
    ...
    class Explosion {
        ...
        update(deltaTime) {
            ...
            if (this.frameX > this.maxWidth) this.markedForDeletion = true;
        }
        draw(context) {
    ...
    class UI {
        ...
        draw(context) {
            ...
            //timer
            const fortmattedTime = (this.game.gameTime * 0.001).toFixed(1);
            context.fillText('Timer: ' + fortmattedTime, 20, 100);
            // game over messages
            if (this.game.gameOver) {
                ...
                if (this.game.score > this.game.winningScore) {
                    message1 = '...You Win...';
                    message2 = 'Kongratulations';
                } else { 
                    message1 = '...You Lose...';
                    message2 = 'Kommiserations';
                }
    ...
    class Game {
        constructor(width, height) {
            ...
            this.ui = new UI(this);
            this.keys = []; // array for tracking keys pressed
            this.enemies = [];
            this.particles = [];
            this.explosions = [];
            this.enemyTimer = 0;
